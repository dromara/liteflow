...
public final class AgentLoggingMiddleware implements MiddlewareBase {

    private static final LFLog LOG = LFLoggerManager.getLogger(AgentLoggingMiddleware.class);
    private final boolean enabled;
    private final Consumer<String> warningSink;

    public AgentLoggingMiddleware(boolean enabled) {
        this(enabled, message -> LOG.warn(message));
    }

    AgentLoggingMiddleware(boolean enabled, Consumer<String> warningSink) {
