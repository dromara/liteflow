/**
 * AgentScope Harness 2.0.3 integration included in LiteFlow Agent core.
 *
 * <p>This package adds compaction, memory, skills, typed subagent declarations, task and plan
