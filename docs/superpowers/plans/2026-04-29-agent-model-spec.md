# Agent ModelSpec 重设计 实施计划

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** 把 `AgentComponent` 的模型声明 API 从「子类直接构造 agentscope `Model`」重构为「子类返回 vendor-neutral 的 `ModelSpec`、由框架根据 `AgentConfig` 解析 credential 并构造 `Model`」。

**Architecture:** 核心模块新增 `ModelSpec<SELF>` 抽象类（共性 setter + `resolve(AgentConfig)` SPI）和 `CredentialResolver` 帮助类。每个 provider 子模块新增以平台命名的入口类（如 `OpenAI`、`DeepSeek`、`Anthropic`、`Gemini`、`DashScope`）和对应的 `XxxSpec` 子类（暴露各家平台特异参数）。`AgentComponent` 的 `buildModel` 由 `abstract` 降级为带默认实现的可选钩子，新抽象方法 `model(ctx)` 取而代之。

**Tech Stack:** Java 17、Maven 多模块、JUnit 5、AssertJ、agentscope-core SDK、Spring Boot（测试）。

参考设计文档：`docs/superpowers/specs/2026-04-29-agent-model-spec-design.md`
...
**core 模块** (`liteflow-agent/liteflow-agent-core`)
...
**openai 模块** (`liteflow-agent/liteflow-agent-openai`)
...
**anthropic 模块** (`liteflow-agent/liteflow-agent-anthropic`)
...
**gemini 模块** (`liteflow-agent/liteflow-agent-gemini`)
...
**dashscope 模块** (`liteflow-agent/liteflow-agent-dashscope`)
...
**测试**（`liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/...`）
...
- `liteflow-agent/liteflow-agent-core/src/main/java/com/yomahub/liteflow/agent/component/AgentComponent.java` — 抽象方法切换
- `liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/test/agent/cmp/DeepSeekAgentCmp.java`
...
**Files:**
- Create: `liteflow-agent/liteflow-agent-core/src/main/java/com/yomahub/liteflow/agent/model/ModelSpec.java`
- Test: `liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/model/ModelSpecTest.java`

- [ ] **Step 1: 写失败测试 — `ModelSpec` 提供共性 fluent setter**

`liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/model/ModelSpecTest.java`:
...
`liteflow-agent/liteflow-agent-core/src/main/java/com/yomahub/liteflow/agent/model/ModelSpec.java`:
...
> **重要**：`resolve` 必须是 `public`，因为 Task 8 中 `AgentComponent`（在 `com.yomahub.liteflow.agent.component` 包）会调用 `model(ctx).resolve(agentConfig())`。Java 不允许 override 缩小可见性，所以后续 Tasks 3-7 中所有 spec 子类的 `resolve` override 也必须是 `public`，测试中的 `TestSpec.resolve` 同理。
...
```bash
git add liteflow-agent/liteflow-agent-core/src/main/java/com/yomahub/liteflow/agent/model/ModelSpec.java \
        liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/model/ModelSpecTest.java
git commit -m "$(cat <<'EOF'
feat(agent-core): introduce ModelSpec base class
...
**Files:**
- Create: `liteflow-agent/liteflow-agent-core/src/main/java/com/yomahub/liteflow/agent/model/CredentialResolver.java`
- Test: `liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/model/CredentialResolverTest.java`

- [ ] **Step 1: 写失败测试**

`liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/model/CredentialResolverTest.java`:
...
`liteflow-agent/liteflow-agent-core/src/main/java/com/yomahub/liteflow/agent/model/CredentialResolver.java`:
...
```bash
git add liteflow-agent/liteflow-agent-core/src/main/java/com/yomahub/liteflow/agent/model/CredentialResolver.java \
        liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/model/CredentialResolverTest.java
git commit -m "$(cat <<'EOF'
feat(agent-core): add CredentialResolver helper
...
**Files:**
- Create: `liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAISpec.java`
- Create: `liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAI.java`
- Test: `liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/openai/OpenAIEntryTest.java`

- [ ] **Step 1: 写失败测试**

`liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/openai/OpenAIEntryTest.java`:
...
`liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAISpec.java`:
...
`liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAI.java`:
...
```bash
git add liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAISpec.java \
        liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAI.java \
        liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/openai/OpenAIEntryTest.java
git commit -m "$(cat <<'EOF'
feat(agent-openai): add OpenAI entry and OpenAISpec
...
**Files:**
- Create: `liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAICompatibleSpec.java`
- Create: `liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/DeepSeek.java`
- Create: `liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/Kimi.java`
- Create: `liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/GLM.java`
- Create: `liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/Minimax.java`
- Create: `liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAICompatible.java`
- Test: `liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/openai/OpenAICompatibleEntryTest.java`

- [ ] **Step 1: 写失败测试**

`liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/openai/OpenAICompatibleEntryTest.java`:
...
`liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAICompatibleSpec.java`:
...
```bash
git add liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAICompatibleSpec.java \
        liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/DeepSeek.java \
        liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/Kimi.java \
        liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/GLM.java \
        liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/Minimax.java \
        liteflow-agent/liteflow-agent-openai/src/main/java/com/yomahub/liteflow/agent/openai/OpenAICompatible.java \
        liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/openai/OpenAICompatibleEntryTest.java
git commit -m "$(cat <<'EOF'
feat(agent-openai): add OpenAI-compatible entries
...
**Files:**
- Create: `liteflow-agent/liteflow-agent-anthropic/src/main/java/com/yomahub/liteflow/agent/anthropic/AnthropicThinking.java`
- Create: `liteflow-agent/liteflow-agent-anthropic/src/main/java/com/yomahub/liteflow/agent/anthropic/AnthropicSpec.java`
- Create: `liteflow-agent/liteflow-agent-anthropic/src/main/java/com/yomahub/liteflow/agent/anthropic/Anthropic.java`
- Create: `liteflow-agent/liteflow-agent-anthropic/src/main/java/com/yomahub/liteflow/agent/anthropic/AnthropicCompatible.java`
- Test: `liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/anthropic/AnthropicEntryTest.java`
...
```bash
git add liteflow-agent/liteflow-agent-anthropic/src/main/java/com/yomahub/liteflow/agent/anthropic/AnthropicThinking.java \
        liteflow-agent/liteflow-agent-anthropic/src/main/java/com/yomahub/liteflow/agent/anthropic/AnthropicSpec.java \
        liteflow-agent/liteflow-agent-anthropic/src/main/java/com/yomahub/liteflow/agent/anthropic/Anthropic.java \
        liteflow-agent/liteflow-agent-anthropic/src/main/java/com/yomahub/liteflow/agent/anthropic/AnthropicCompatible.java \
        liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/anthropic/AnthropicEntryTest.java
git commit -m "$(cat <<'EOF'
feat(agent-anthropic): add Anthropic entry and AnthropicSpec
...
**Files:**
- Create: `liteflow-agent/liteflow-agent-gemini/src/main/java/com/yomahub/liteflow/agent/gemini/GeminiThinking.java`
- Create: `liteflow-agent/liteflow-agent-gemini/src/main/java/com/yomahub/liteflow/agent/gemini/GeminiSpec.java`
- Create: `liteflow-agent/liteflow-agent-gemini/src/main/java/com/yomahub/liteflow/agent/gemini/Gemini.java`
- Test: `liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/gemini/GeminiEntryTest.java`
...
```bash
git add liteflow-agent/liteflow-agent-gemini/src/main/java/com/yomahub/liteflow/agent/gemini/GeminiThinking.java \
        liteflow-agent/liteflow-agent-gemini/src/main/java/com/yomahub/liteflow/agent/gemini/GeminiSpec.java \
        liteflow-agent/liteflow-agent-gemini/src/main/java/com/yomahub/liteflow/agent/gemini/Gemini.java \
        liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/gemini/GeminiEntryTest.java
git commit -m "$(cat <<'EOF'
feat(agent-gemini): add Gemini entry and GeminiSpec
...
**Files:**
- Create: `liteflow-agent/liteflow-agent-dashscope/src/main/java/com/yomahub/liteflow/agent/dashscope/DashScopeThinking.java`
- Create: `liteflow-agent/liteflow-agent-dashscope/src/main/java/com/yomahub/liteflow/agent/dashscope/DashScopeSpec.java`
- Create: `liteflow-agent/liteflow-agent-dashscope/src/main/java/com/yomahub/liteflow/agent/dashscope/DashScope.java`
- Test: `liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/dashscope/DashScopeEntryTest.java`
...
```bash
git add liteflow-agent/liteflow-agent-dashscope/src/main/java/com/yomahub/liteflow/agent/dashscope/DashScopeThinking.java \
        liteflow-agent/liteflow-agent-dashscope/src/main/java/com/yomahub/liteflow/agent/dashscope/DashScopeSpec.java \
        liteflow-agent/liteflow-agent-dashscope/src/main/java/com/yomahub/liteflow/agent/dashscope/DashScope.java \
        liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/agent/dashscope/DashScopeEntryTest.java
git commit -m "$(cat <<'EOF'
feat(agent-dashscope): add DashScope entry and DashScopeSpec
...
```bash
mvn -q -DskipTests compile -pl liteflow-agent/liteflow-agent-core -am
```
...
git commit -m "$(cat <<'EOF'
refactor(agent-core): switch abstract from buildModel to model

AgentComponent now requires subclasses to override model(ctx)
...
**Files:**
- Modify: `liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/test/agent/cmp/DeepSeekAgentCmp.java`
...
public class DeepSeekAgentCmp extends AgentComponent {

    @Value("${test.deepseek.model:deepseek-chat}")
    private String modelName;

    @Override
    protected ModelSpec<?> model(AgentContext ctx) {
        return DeepSeek.of(modelName);
    }

    @Override
    protected String systemPrompt(AgentContext ctx) {
        return "你是一名简洁的中文助理，回答严格控制在两句话以内。";
    }

    @Override
    protected String userPrompt(AgentContext ctx) {
...
public class GeminiAgentCmp extends AgentComponent {
...
```bash
cat liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/test/agent/cmp/OpenAIAgentCmp.java
```

把 `protected Model buildModel(AgentContext ctx) { ... OpenAIModelFactory.openai(...) ... }` 替换为：
...
```bash
grep -n "buildModel" liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/test/agent/cmp/MathAgentCmp.java || echo "no buildModel usage"
```
...
```bash
mvn -q test -pl liteflow-testcase-el/liteflow-testcase-el-agent
```

期望：所有 agent 模块的测试（含已有 + 新加）全部通过。
...
```bash
git add liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java/com/yomahub/liteflow/test/agent/cmp/
git commit -m "$(cat <<'EOF'
test(agent): migrate test cmps to ModelSpec API
...
- [ ] **Step 2: 跑 agent 相关模块测试**

```bash
mvn -q test \
    -pl liteflow-agent/liteflow-agent-core,liteflow-agent/liteflow-agent-openai,liteflow-agent/liteflow-agent-anthropic,liteflow-agent/liteflow-agent-gemini,liteflow-agent/liteflow-agent-dashscope,liteflow-testcase-el/liteflow-testcase-el-agent \
    -am
```
...
```bash
grep -rn "extends AgentComponent" liteflow-testcase-el/liteflow-testcase-el-agent/src/test/java | while read line; do
...
grep -E "public (final )?class (OpenAI|DeepSeek|Kimi|GLM|Minimax|Anthropic|AnthropicCompatible|Gemini|DashScope|OpenAICompatible)" \
    liteflow-agent/*/src/main/java/com/yomahub/liteflow/agent/*/*.java
```
...
- `liteflow-testcase-el-agent` 全部测试通过；
