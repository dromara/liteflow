...
/** Agent component base whose model boundary is always deterministic and in-process. */
public abstract class OfflineAgentComponent extends HarnessAgentComponent {
