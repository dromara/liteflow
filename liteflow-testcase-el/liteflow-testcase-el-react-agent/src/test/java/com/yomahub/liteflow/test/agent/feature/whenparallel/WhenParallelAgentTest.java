 ...
 * 才能真正并发执行而不互相串行。
 */
@TestPropertySource("classpath:/feature/whenparallel/application.properties")
...
public class WhenParallelAgentTest extends BaseAgentLiveTest {
    ...
    public void resetProbes() {
        ...
        LiveTestSupport.applyCompatibleCustomOrSkip(liteflowConfig, "WhenParallelAgentTest");
    }
