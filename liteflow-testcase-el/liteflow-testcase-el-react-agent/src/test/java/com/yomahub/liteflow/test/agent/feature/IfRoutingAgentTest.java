...
import com.yomahub.liteflow.test.agent.feature.cmp.DefaultBranchAgentCmp;
import com.yomahub.liteflow.test.agent.feature.cmp.MathBranchAgentCmp;
...
public class IfRoutingAgentTest extends BaseAgentLiveTest {
    ...
    public void resetCounts() {
        ...
        LiveTestSupport.ensureCompatibleCustomCredentialOrSkip(liteflowConfig, "IfRoutingAgentTest");
    }
