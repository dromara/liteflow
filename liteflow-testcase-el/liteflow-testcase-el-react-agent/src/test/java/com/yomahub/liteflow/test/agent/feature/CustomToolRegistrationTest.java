...
import com.yomahub.liteflow.test.agent.feature.cmp.CustomToolAgentCmp;
...
/**
 * 验证 guide §3 中 {@code tools()} 注册的自定义工具会出现在 Agent Toolkit 中。
 *
 * <p>通过 AgentProbe 在 PreReasoning 阶段读取 {@code ReActAgent.getToolkit().getToolNames()}，
 * 不依赖模型是否真的调用工具。
 */
...
public class CustomToolRegistrationTest extends BaseAgentLiveTest {
    ...
    public void resetProbe() {
        ...
        LiveTestSupport.ensureCompatibleCustomCredentialOrSkip(liteflowConfig, "CustomToolRegistrationTest");
    }
