...
import com.yomahub.liteflow.test.agent.feature.cmp.MultiAgentACmp;
import com.yomahub.liteflow.test.agent.feature.cmp.MultiAgentBCmp;
...
public class MultiAgentChainTest extends BaseAgentLiveTest {
    ...
    public void resetProbes() {
        ...
        LiveTestSupport.ensureCompatibleCustomCredentialOrSkip(liteflowConfig, "MultiAgentChainTest");
    }
