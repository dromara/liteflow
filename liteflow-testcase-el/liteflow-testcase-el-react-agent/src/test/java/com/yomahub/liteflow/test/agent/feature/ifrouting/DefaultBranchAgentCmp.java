...
public class DefaultBranchAgentCmp extends OfflineReActAgentComponent {
    ...
    protected void handleReply(Msg reply, com.yomahub.liteflow.agent.context.LiteFlowAgentContext context) {
        context.getSlot().setOutput("defaultBranchAgent", reply == null ? null : reply.getTextContent());
    }
}
