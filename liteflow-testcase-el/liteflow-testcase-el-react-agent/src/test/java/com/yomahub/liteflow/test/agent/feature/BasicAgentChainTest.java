...
/**
 * 验证最基础的 THEN 链路集成：prepare → agent → record。
 *
...
@SpringBootTest(classes = BasicAgentChainTest.class)
@EnableAutoConfiguration
@ComponentScan({
        "com.yomahub.liteflow.test.agent.cmp",
        "com.yomahub.liteflow.test.agent.feature.cmp"
})
public class BasicAgentChainTest extends BaseAgentLiveTest {

    @BeforeEach
    public void resetProbe() {
        BasicAgentCmp.reset();
        LiveTestSupport.ensureCompatibleCustomCredentialOrSkip(liteflowConfig, "BasicAgentChainTest");
    }
